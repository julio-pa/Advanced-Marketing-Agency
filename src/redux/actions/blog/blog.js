...
export const get_blog_list_page = (page) => async dispatch => {
  ...
  try {
    const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/blog/list?p=${page}`, config)
...
export const get_blog_list_category = (slug) => async dispatch => {
  ...
  try {
    const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/blog/by_category?slug=${slug}`, config)
...
export const get_blog_list_category_page = (slug, page) => async dispatch => {
  ...
  try {
    const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/blog/by_category?slug=${slug}&p=${page}`, config)
...
export const search_blog = (search_term) => async dispatch => {
  ...
  try {
    const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/blog/search?s=${search_term}`, config);
...
export const search_blog_page = (search_term, page) => async dispatch => {
  ...
  try {
    const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/blog/search?p=${page}&s=${search_term}`, config);
